...
function AddHeightModal({ isOpen, onClose }) {
  ...
  return (
    <ModalOverlay>
      <ModalContainer>
        ...
        <InputField type="number" placeholder="Enter height in cm" />
        <Label>Date</Label>
        <InputField type="date" placeholder="Enter end date" />
        <ButtonContainer>
          <CancelButton onClick={onClose}>Cancel</CancelButton>
          <UpdateButton onClick={onClose}>Add Height</UpdateButton>
        </ButtonContainer>
      </ModalContainer>
    </ModalOverlay>
  );
