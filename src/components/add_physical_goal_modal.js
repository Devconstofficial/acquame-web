...
function AddPhysicalGoalModal({ isOpen, onClose }) {
      ...
      <ModalContainer>
        ...
        <RowContainer>
          <div >
            ...
            <InputField type="number" placeholder="Enter your current value" style={{width: "80%"}}/>
          </div>
          <div >
            <Label>Target Value</Label>
            <InputField type="number" placeholder="Enter your target value" style={{width: "80%"}} />
          </div>
        </RowContainer>
...
export default AddPhysicalGoalModal;
