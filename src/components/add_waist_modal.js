...
function AddWaistModal({ isOpen, onClose }) {
  ...
  return (
    <ModalOverlay>
      <ModalContainer>
        ...
        <Label>Add Waist</Label>
        <InputField type="number" placeholder="Enter waist in cm" />
        <Label>Date</Label>
        <InputField type="date" placeholder="Enter end date" />
      
        <ButtonContainer>
          <CancelButton onClick={onClose}>Cancel</CancelButton>
          <UpdateButton onClick={onClose}>Add Waist</UpdateButton>
        </ButtonContainer>
      </ModalContainer>
    </ModalOverlay>
  );
